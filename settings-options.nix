# Vendored from nixpkgs nixos/modules/services/misc/servarr/settings-options.nix
# We vendor this because we can't import nixpkgs module internals from a flake.
{ lib, pkgs }:
{
